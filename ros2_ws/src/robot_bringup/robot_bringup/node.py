"""ROS2 thin wrapper node for robot_bringup.
...
def main() -> None:
    try:
        ...
        print("robot_bringup: rclpy not available — use PC mock stack.")
        return
    ...
    class AmpNode(Node):
        def __init__(self) -> None:
            ...
            self.get_logger().info("robot_bringup started (amp_core-backed)")
