"""ROS2 thin wrapper node for slam_integration.
...
def main() -> None:
    try:
        ...
        print("slam_integration: rclpy not available — use PC mock stack.")
        return
    ...
    class AmpNode(Node):
        def __init__(self) -> None:
            ...
            self.get_logger().info("slam_integration started (amp_core-backed)")
