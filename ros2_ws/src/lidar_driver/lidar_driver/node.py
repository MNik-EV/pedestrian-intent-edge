"""ROS2 thin wrapper node for lidar_driver.
...
def main() -> None:
    try:
        ...
        print("lidar_driver: rclpy not available — use PC mock stack.")
        return
    ...
    class AmpNode(Node):
        def __init__(self) -> None:
            ...
            self.get_logger().info("lidar_driver started (amp_core-backed)")
