...
2W and streamed to a laptop over Wi-Fi; an LD19 2D LiDAR connects directly to the laptop
over USB–serial. The laptop runs detection, geometric fusion, tracking, logging, and the
live FastAPI dashboard.
